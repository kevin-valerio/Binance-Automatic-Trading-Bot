...
public class BinanceBot {
    ...
    private static Integer MAX_SIMULTANEOUS_TRADES = 2;
    ...
    private static void generateTimeSeriesCache(List<String> symbols) {
        for (String symbol : symbols) {
            ...
            try {
                if (symbol.contains("LTC") || symbol.contains("ETH") || symbol.contains("NEO") ||
                        symbol.contains("OMG") || symbol.contains("XRP") || symbol.contains("XMR") || symbol.contains("BSV") ||
                        symbol.contains("BCH") || symbol.contains("XLM") || symbol.contains("BAT") ||
                        symbol.contains("TRX") || symbol.contains("BNB") || symbol.contains("EOS") || symbol.contains("ADA") ||
                        symbol.contains("IOTA") || symbol.contains("ICX") || symbol.contains("ZRX")) {
